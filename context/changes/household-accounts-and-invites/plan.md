...
- [x] 5.1 Access-control tests pass: `uv run python manage.py test households.tests.test_access_control`
- [x] 5.2 Full suite passes: `uv run python manage.py test`
- [x] 5.3 Type checking passes: `uv run mypy .`
- [x] 5.4 System checks pass: `uv run python manage.py check`
- [x] 5.5 Migrations are complete: `uv run python manage.py makemigrations --check --dry-run`

#### Manual

- [x] 5.6 Empty list page reads sensibly in Polish at phone width
- [x] 5.7 No redirect loop for anonymous, logged-in-without-household, or logged-in-with-household
- [x] 5.8 `docs/learning/` entries written and indexed
- [x] 5.9 End-to-end run on the live URL: two accounts, one household, both members visible, list shell reachable by both
